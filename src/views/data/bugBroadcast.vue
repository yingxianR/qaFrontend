        ...
        <a-col :xs="24" class="export-filter-col">
          <a-dropdown :disabled="!reportText">
            ...
            <a-menu slot="overlay" @click="handleExportMenuClick">
              ...
              <a-menu-item key="oxiOverview">线上oxi环境缺陷统计</a-menu-item>
              <a-menu-item key="nonOxiOverview">非线上oxi环境缺陷统计</a-menu-item>
            </a-menu>
          </a-dropdown>
        </a-col>
      </a-row>
  ...
  methods: {
    ...
    async exportReportImage (type) {
      ...
      try {
        ...
        link.href = dataUrl
        const suffixMap = {
          oxiOverview: '线上oxi环境缺陷统计',
          nonOxiOverview: '非线上oxi环境缺陷统计',
          trend: 'Bug趋势图',
          overview: '概览',
          detail: '明细'
        }
